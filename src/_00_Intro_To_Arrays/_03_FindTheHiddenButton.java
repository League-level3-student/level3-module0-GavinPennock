...
public class _03_FindTheHiddenButton implements ActionListener {
	...
	public void start() {
		...
		// created in step 3
		buttons=new JButton[Integer.parseInt(num)];
		...
		JOptionPane.showMessageDialog(null, "pick the right button or else I'll steal all your V-Bucks");
		// 13. initialize the hiddenButton variable to a random number less than
		// the int created in step 3
		Random ran=new Random();
		int random=ran.nextInt(Integer.parseInt(num));
		hiddenButton=random;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(buttonClicked==buttons[hiddenButton]) {
			JOptionPane.showMessageDialog(null, "YOU WIN!! YOU PRESSED YOUR MOUSE!!");
		}else {
